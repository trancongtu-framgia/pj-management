            ...
            <table class="table table-hover">
                ...
                @foreach ($exercise as $exercise)
                    <tr>
                        ...
                        <td><a href="{{ url('exercise/' . $task->id . 'detail') }}">{{ $exercise->name }}</a></td>
                        <td><a href="{{ url('exercise/' . $task->id . '/delete') }}" onclick="return confirm({{ __('eng.del_confirm') }})">{{ __('eng.del') }}</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
